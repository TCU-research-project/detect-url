...
export default function Navbar() {
	...
	return (
		<>
			<nav className="bg-[#ccccff] rounded-b-xl border-gray-200 px-2 sm:px-4 py-2.5 mb-4">
				<div onClick={() => { router.push('/'); }} className="container flex flex-wrap items-center justify-between ml-4 mr-2">
